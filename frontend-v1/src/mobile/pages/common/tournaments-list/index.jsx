  ...
  return (
    <div className="mobile-container">
      ...
      <div className="mobile-header">
        ...
        <h1 className="mobile-header-title">토너먼트 일정</h1>
        <img 
          src={aslLogo}
          alt="ASL 로고" 
      ...
      <div className="mobile-content">
        <div className="mobile-page-title">토너먼트 일정</div>
        <p>참여 가능한 토너먼트 일정을 확인하세요.</p>
        
        {/* 컨텐츠 추가 예정 */}
        <div className="mobile-empty-state">
          <i className="fas fa-calendar-alt mobile-empty-icon"></i>
