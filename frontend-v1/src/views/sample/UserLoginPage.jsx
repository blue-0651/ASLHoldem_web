        ...
        <Row className="align-items-center text-center">
          <Col>
            <Card.Body className="card-body">
              ...
              <h4 className="mb-3 f-w-400 asl-admin-text">ASL 사용자 로그인</h4>
              ...
              <Button variant="primary" size="lg" className="btn-block mt-4 mb-4 w-100">
                로그인
              </Button>
              ...
              <p className="mb-2 asl-admin-text">
                <NavLink to="/auth/signin-1" className="f-w-400">
                  <span className="asl-admin-text text-decoration-underline text-underline-offset-4 fs-6">매장 관리자 로그인</span>
                </NavLink>
              </p>
            </Card.Body>
          </Col>
